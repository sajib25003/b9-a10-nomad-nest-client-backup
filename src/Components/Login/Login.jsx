...
const Login = () => {
  const { signIn, googleSignInUser, githubSignInUser } =
          ...
          <div className="card shrink-0 w-5/6 lg:w-3/5 shadow-2xl bg-base-100">
            <form onSubmit={handleLogin} className="card-body">
              ...
              <div className="form-control mt-6">
                <input
                  className="btn border-white bg-black text-white font-bold w-full"
                  type="submit"
                  value="Login"
                />
              </div>
              ...
              <div className="flex flex-row items-center gap-4">
                <h5 className="hidden md:flex font-semibold text-lg text-gray-400">
                  Login with{" "}
                </h5>
                <button
