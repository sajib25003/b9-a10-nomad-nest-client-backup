...
const Register = () => {
  ...
  const onSubmit = (data) => {
    ...
    createUser(email, password)
      .then((result) => {
        ...
        fetch("https://nomad-nest-server.vercel.app/user", {
          method: "POST",
          headers: {
  ...
  return (
    <div className="">
      <Helmet>
        <title>Nomad Nest | Register</title>
      </Helmet>
      <div className=" py-4 lg:py-20 bg-base-200">
          ...
          <div className="card shrink-0 w-5/6 lg:w-3/5 shadow-2xl bg-base-100">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="card-body">
              ...
              <div className="form-control mt-6">
                ...
                <input
                  className="btn bg-black border-white text-white font-bold w-full"
                  type="submit"
                  value="Register"
                />
              </div>
